        ...
        <div className="wrap">
          ...
          <div className="team">
            ...
            <div className="member reveal reveal-delay-2">
              ...
              <div className="author-links">
                <a href={`https://wa.me/5549991637585?text=${encodeURIComponent("Oi Cristian! Quero saber mais sobre o app da LeMans Barber Club.")}`} target="_blank" rel="noopener noreferrer">
